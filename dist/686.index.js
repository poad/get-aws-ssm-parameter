...
const client_1 = __webpack_require__(4087);
...
const fromWebToken_1 = __webpack_require__(599);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(3252)));
...
var fromTokenFile = __webpack_require__(1214);
var fromWebToken = __webpack_require__(599);
