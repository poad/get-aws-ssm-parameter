...
const fromWebToken_1 = __webpack_require__(1801);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4799)));
...
var fromTokenFile = __webpack_require__(9875);
var fromWebToken = __webpack_require__(1801);
