...
const ruleset_1 = __webpack_require__(8160);
...
var middlewareUserAgent = __webpack_require__(6825);
...
var httpAuthSchemeProvider = __webpack_require__(8789);
var runtimeConfig = __webpack_require__(2124);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5325));
const core_1 = __webpack_require__(786);
...
const runtimeConfig_shared_1 = __webpack_require__(9901);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8789);
const endpointResolver_1 = __webpack_require__(5611);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(1634);
var tokenProviders = __webpack_require__(5511);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6178); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(9626);
...
var client = __webpack_require__(1634);
var httpAuthSchemes = __webpack_require__(3261);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(1247);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 584).then(__webpack_require__.t.bind(__webpack_require__, 8584, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 584).then(__webpack_require__.t.bind(__webpack_require__, 8584, 19));
