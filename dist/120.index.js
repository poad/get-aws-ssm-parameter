...
const ruleset_1 = __webpack_require__(8980);
...
var middlewareRecursionDetection = __webpack_require__(2599);
var middlewareUserAgent = __webpack_require__(676);
...
var httpAuthSchemeProvider = __webpack_require__(5889);
var runtimeConfig = __webpack_require__(1808);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(4093));
const core_1 = __webpack_require__(8362);
...
const runtimeConfig_shared_1 = __webpack_require__(9553);
...
const httpAuthSchemeProvider_1 = __webpack_require__(5889);
const endpointResolver_1 = __webpack_require__(6263);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(1722);
var tokenProviders = __webpack_require__(7088);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1491); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(8270);
...
var client = __webpack_require__(1722);
var httpAuthSchemes = __webpack_require__(1813);
var propertyProvider = __webpack_require__(7717);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 436).then(__webpack_require__.t.bind(__webpack_require__, 3436, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 436).then(__webpack_require__.t.bind(__webpack_require__, 3436, 19));
