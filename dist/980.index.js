...
const ruleset_1 = __webpack_require__(96);
...
var middlewareUserAgent = __webpack_require__(2512);
var configResolver = __webpack_require__(7358);
var core = __webpack_require__(6304);
...
var middlewareRetry = __webpack_require__(2386);
var smithyClient = __webpack_require__(3487);
var httpAuthSchemeProvider = __webpack_require__(1989);
var runtimeConfig = __webpack_require__(1164);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9657));
const core_1 = __webpack_require__(4134);
...
const runtimeConfig_shared_1 = __webpack_require__(5645);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1989);
const endpointResolver_1 = __webpack_require__(587);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(9342);
var tokenProviders = __webpack_require__(3708);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(511); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(7946);
...
var client = __webpack_require__(9342);
var httpAuthSchemes = __webpack_require__(5017);
var propertyProvider = __webpack_require__(7717);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 928).then(__webpack_require__.t.bind(__webpack_require__, 5928, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 928).then(__webpack_require__.t.bind(__webpack_require__, 5928, 19));
