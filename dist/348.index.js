...
const fromWebToken_1 = __webpack_require__(7165);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4675)));
...
var fromTokenFile = __webpack_require__(6951);
var fromWebToken = __webpack_require__(7165);
