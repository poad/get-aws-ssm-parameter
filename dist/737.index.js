...
const fromWebToken_1 = __webpack_require__(1286);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(7528)));
...
var fromTokenFile = __webpack_require__(5998);
var fromWebToken = __webpack_require__(1286);
