...
var tokenProviders = __webpack_require__(608);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4823); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(4008);
...
var client$1 = __webpack_require__(5557);
...
var httpAuthSchemes = __webpack_require__(120);
var serde = __webpack_require__(7643);
var nodeHttpHandler = __webpack_require__(3485);
var protocols$1 = __webpack_require__(4315);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 110).then(__webpack_require__.t.bind(__webpack_require__, 4110, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 110).then(__webpack_require__.t.bind(__webpack_require__, 4110, 19));
