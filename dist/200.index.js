...
var client = __webpack_require__(4087);
...
var client = __webpack_require__(4087);
var tokenProviders = __webpack_require__(2703);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1315); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(967);
...
const core_1 = __webpack_require__(5631);
...
const ruleset_1 = __webpack_require__(4543);
...
var middlewareUserAgent = __webpack_require__(9559);
...
var httpAuthSchemeProvider = __webpack_require__(8968);
var runtimeConfig = __webpack_require__(441);
var regionConfigResolver = __webpack_require__(9285);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(1667);
var errors = __webpack_require__(4831);
var SSOServiceException = __webpack_require__(3365);
...
const SSOServiceException_1 = __webpack_require__(3365);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(2066));
const core_1 = __webpack_require__(5631);
const util_user_agent_node_1 = __webpack_require__(6163);
...
const runtimeConfig_shared_1 = __webpack_require__(3870);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(5631);
const protocols_1 = __webpack_require__(3465);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8968);
const endpointResolver_1 = __webpack_require__(6590);
const schemas_0_1 = __webpack_require__(1667);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(4831);
const SSOServiceException_1 = __webpack_require__(3365);
...
var client = __webpack_require__(4087);
var httpAuthSchemes = __webpack_require__(1474);
var propertyProvider = __webpack_require__(4036);
var sharedIniFileLoader = __webpack_require__(7016);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 719).then(__webpack_require__.t.bind(__webpack_require__, 1719, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 719).then(__webpack_require__.t.bind(__webpack_require__, 1719, 23));
