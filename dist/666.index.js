...
const core_1 = __webpack_require__(583);
...
const ruleset_1 = __webpack_require__(2806);
...
var middlewareUserAgent = __webpack_require__(8727);
var configResolver = __webpack_require__(7358);
var core = __webpack_require__(2983);
var schema = __webpack_require__(419);
var middlewareContentLength = __webpack_require__(5550);
var middlewareEndpoint = __webpack_require__(7469);
var middlewareRetry = __webpack_require__(2260);
var smithyClient = __webpack_require__(1715);
var httpAuthSchemeProvider = __webpack_require__(7339);
var runtimeConfig = __webpack_require__(3058);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3239));
const core_1 = __webpack_require__(583);
const util_user_agent_node_1 = __webpack_require__(2975);
const config_resolver_1 = __webpack_require__(7358);
const hash_node_1 = __webpack_require__(6354);
const middleware_retry_1 = __webpack_require__(2260);
...
const runtimeConfig_shared_1 = __webpack_require__(2795);
const smithy_client_1 = __webpack_require__(1715);
const util_defaults_mode_node_1 = __webpack_require__(2868);
const smithy_client_2 = __webpack_require__(1715);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(583);
const protocols_1 = __webpack_require__(8801);
const core_2 = __webpack_require__(2983);
const smithy_client_1 = __webpack_require__(1715);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7339);
const endpointResolver_1 = __webpack_require__(2757);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(9135);
...
var client = __webpack_require__(9135);
var tokenProviders = __webpack_require__(4542);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3045); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(3392);
...
var client = __webpack_require__(9135);
var httpAuthSchemes = __webpack_require__(7882);
var propertyProvider = __webpack_require__(7717);
var sharedIniFileLoader = __webpack_require__(2787);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 94).then(__webpack_require__.t.bind(__webpack_require__, 94, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 94).then(__webpack_require__.t.bind(__webpack_require__, 94, 19));
