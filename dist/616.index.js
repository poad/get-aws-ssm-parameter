...
const client_1 = __webpack_require__(6015);
const config_1 = __webpack_require__(1182);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(5929);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 893).then(__webpack_require__.t.bind(__webpack_require__, 8893, 19));
...
var fromTokenFile = __webpack_require__(1091);
var fromWebToken = __webpack_require__(5929);
