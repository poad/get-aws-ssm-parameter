...
const client_1 = __webpack_require__(2217);
...
const fromWebToken_1 = __webpack_require__(9189);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4962)));
...
var fromTokenFile = __webpack_require__(5167);
var fromWebToken = __webpack_require__(9189);
...
const middleware_user_agent_1 = __webpack_require__(9976);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9133);
const EndpointParameters_1 = __webpack_require__(3609);
const runtimeConfig_1 = __webpack_require__(8868);
const runtimeExtensions_1 = __webpack_require__(4352);
...
const STSClient_1 = __webpack_require__(3809);
...
const ruleset_1 = __webpack_require__(4680);
...
const runtimeConfig_shared_1 = __webpack_require__(1093);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9133);
const endpointResolver_1 = __webpack_require__(947);
const getRuntimeConfig = (config) => {
    return {
...
const smithy_client_1 = __webpack_require__(4869);
const httpAuthExtensionConfiguration_1 = __webpack_require__(2950);
