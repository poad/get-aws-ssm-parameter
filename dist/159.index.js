...
const core_1 = __webpack_require__(6807);
const util_middleware_1 = __webpack_require__(7551);
...
const util_endpoints_1 = __webpack_require__(3767);
const util_endpoints_2 = __webpack_require__(2795);
const ruleset_1 = __webpack_require__(3165);
...
var middlewareHostHeader = __webpack_require__(9701);
var middlewareLogger = __webpack_require__(3151);
var middlewareRecursionDetection = __webpack_require__(1339);
var middlewareUserAgent = __webpack_require__(9302);
var configResolver = __webpack_require__(1227);
var core = __webpack_require__(1899);
var middlewareContentLength = __webpack_require__(8067);
var middlewareEndpoint = __webpack_require__(2688);
var middlewareRetry = __webpack_require__(4771);
var smithyClient = __webpack_require__(9824);
var httpAuthSchemeProvider = __webpack_require__(9030);
var runtimeConfig = __webpack_require__(4431);
var regionConfigResolver = __webpack_require__(2696);
var protocolHttp = __webpack_require__(6967);
var middlewareSerde = __webpack_require__(1722);
var core$1 = __webpack_require__(6807);
...
const tslib_1 = __webpack_require__(2753);
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5188));
const core_1 = __webpack_require__(6807);
const util_user_agent_node_1 = __webpack_require__(6251);
const config_resolver_1 = __webpack_require__(1227);
const hash_node_1 = __webpack_require__(7907);
const middleware_retry_1 = __webpack_require__(4771);
const node_config_provider_1 = __webpack_require__(5065);
const node_http_handler_1 = __webpack_require__(1432);
const util_body_length_node_1 = __webpack_require__(2417);
const util_retry_1 = __webpack_require__(8551);
const runtimeConfig_shared_1 = __webpack_require__(7788);
const smithy_client_1 = __webpack_require__(9824);
const util_defaults_mode_node_1 = __webpack_require__(4276);
const smithy_client_2 = __webpack_require__(9824);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(6807);
const core_2 = __webpack_require__(1899);
const smithy_client_1 = __webpack_require__(9824);
const url_parser_1 = __webpack_require__(8351);
const util_base64_1 = __webpack_require__(2054);
const util_utf8_1 = __webpack_require__(8430);
const httpAuthSchemeProvider_1 = __webpack_require__(9030);
const endpointResolver_1 = __webpack_require__(4736);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(6967);
var core = __webpack_require__(1899);
var propertyProvider = __webpack_require__(8001);
var client = __webpack_require__(8863);
var signatureV4 = __webpack_require__(5203);
...
var propertyProvider = __webpack_require__(8001);
var sharedIniFileLoader = __webpack_require__(981);
var client = __webpack_require__(8863);
var tokenProviders = __webpack_require__(7060);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(3718); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(661);
...
var client = __webpack_require__(8863);
var httpAuthSchemes = __webpack_require__(5194);
var propertyProvider = __webpack_require__(8001);
var sharedIniFileLoader = __webpack_require__(981);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 924).then(__webpack_require__.t.bind(__webpack_require__, 5924, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 924).then(__webpack_require__.t.bind(__webpack_require__, 5924, 19));
