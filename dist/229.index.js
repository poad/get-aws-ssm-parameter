...
const fromWebToken_1 = __webpack_require__(8450);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4388)));
...
var fromTokenFile = __webpack_require__(6874);
var fromWebToken = __webpack_require__(8450);
