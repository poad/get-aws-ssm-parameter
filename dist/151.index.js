...
const fromWebToken_1 = __webpack_require__(332);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4163)));
...
var fromTokenFile = __webpack_require__(7212);
var fromWebToken = __webpack_require__(332);
