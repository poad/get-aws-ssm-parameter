...
const ruleset_1 = __webpack_require__(3789);
...
var middlewareUserAgent = __webpack_require__(8401);
var configResolver = __webpack_require__(4367);
var core = __webpack_require__(1986);
var schema = __webpack_require__(9770);
var middlewareContentLength = __webpack_require__(595);
var middlewareEndpoint = __webpack_require__(4385);
var middlewareRetry = __webpack_require__(4204);
var smithyClient = __webpack_require__(1899);
var httpAuthSchemeProvider = __webpack_require__(8886);
var runtimeConfig = __webpack_require__(9599);
var regionConfigResolver = __webpack_require__(5731);
var protocolHttp = __webpack_require__(2919);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5088));
const core_1 = __webpack_require__(2566);
...
const runtimeConfig_shared_1 = __webpack_require__(9260);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8886);
const endpointResolver_1 = __webpack_require__(480);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(2919);
var core = __webpack_require__(1986);
var propertyProvider = __webpack_require__(1219);
var client = __webpack_require__(8689);
var signatureV4 = __webpack_require__(927);
...
var propertyProvider = __webpack_require__(1219);
var sharedIniFileLoader = __webpack_require__(8786);
var client = __webpack_require__(8689);
var tokenProviders = __webpack_require__(3081);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9456); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(1701);
...
var client = __webpack_require__(8689);
var httpAuthSchemes = __webpack_require__(500);
var propertyProvider = __webpack_require__(1219);
var sharedIniFileLoader = __webpack_require__(8786);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 263).then(__webpack_require__.t.bind(__webpack_require__, 8263, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 263).then(__webpack_require__.t.bind(__webpack_require__, 8263, 19));
