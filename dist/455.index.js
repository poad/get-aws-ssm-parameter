...
var tokenProviders = __webpack_require__(3195);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4678); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(6440);
...
const ruleset_1 = __webpack_require__(1678);
...
var middlewareUserAgent = __webpack_require__(2801);
...
var middlewareRetry = __webpack_require__(7664);
var smithyClient = __webpack_require__(4998);
var httpAuthSchemeProvider = __webpack_require__(6243);
var runtimeConfig = __webpack_require__(4890);
var regionConfigResolver = __webpack_require__(2585);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(252);
var errors = __webpack_require__(3504);
var SSOServiceException = __webpack_require__(352);
...
const SSOServiceException_1 = __webpack_require__(352);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5429));
const client_1 = __webpack_require__(2497);
const httpAuthSchemes_1 = __webpack_require__(5748);
const util_user_agent_node_1 = __webpack_require__(9753);
const config_resolver_1 = __webpack_require__(6477);
const hash_node_1 = __webpack_require__(8300);
const middleware_retry_1 = __webpack_require__(7664);
...
const runtimeConfig_shared_1 = __webpack_require__(5139);
...
const httpAuthSchemeProvider_1 = __webpack_require__(6243);
const endpointResolver_1 = __webpack_require__(6941);
const schemas_0_1 = __webpack_require__(252);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(3504);
const SSOServiceException_1 = __webpack_require__(352);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 414).then(__webpack_require__.t.bind(__webpack_require__, 414, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 414).then(__webpack_require__.t.bind(__webpack_require__, 414, 23));
