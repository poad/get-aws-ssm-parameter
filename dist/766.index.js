...
const ruleset_1 = __webpack_require__(7994);
...
var httpAuthSchemeProvider = __webpack_require__(4311);
var runtimeConfig = __webpack_require__(3782);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(4483));
const core_1 = __webpack_require__(5897);
...
const runtimeConfig_shared_1 = __webpack_require__(3935);
...
const httpAuthSchemeProvider_1 = __webpack_require__(4311);
const endpointResolver_1 = __webpack_require__(8177);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(4945);
var tokenProviders = __webpack_require__(1130);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(2977); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(5956);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 122).then(__webpack_require__.t.bind(__webpack_require__, 122, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 122).then(__webpack_require__.t.bind(__webpack_require__, 122, 19));
