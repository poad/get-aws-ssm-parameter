...
const client_1 = __webpack_require__(4424);
...
const fromWebToken_1 = __webpack_require__(8815);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(4975)));
...
var fromTokenFile = __webpack_require__(6796);
var fromWebToken = __webpack_require__(8815);
