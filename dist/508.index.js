...
var config = __webpack_require__(2633);
var client = __webpack_require__(4987);
var credentialProviderLogin = __webpack_require__(8170);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 867).then(__webpack_require__.t.bind(__webpack_require__, 867, 19));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 686).then(__webpack_require__.t.bind(__webpack_require__, 686, 19));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 686).then(__webpack_require__.t.bind(__webpack_require__, 686, 19));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 313, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 740).then(__webpack_require__.t.bind(__webpack_require__, 5740, 19));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 401).then(__webpack_require__.t.bind(__webpack_require__, 9401, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 730).then(__webpack_require__.t.bind(__webpack_require__, 730, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 548).then(__webpack_require__.t.bind(__webpack_require__, 3548, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
var client = __webpack_require__(4987);
var config = __webpack_require__(2633);
var protocols = __webpack_require__(3996);
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await __webpack_require__.e(/* import() */ 670).then(__webpack_require__.t.bind(__webpack_require__, 9670, 19));
