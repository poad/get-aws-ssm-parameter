...
var client = __webpack_require__(1619);
var tokenProviders = __webpack_require__(7660);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(8211); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(2078);
...
const httpAuthSchemes_1 = __webpack_require__(9601);
...
const bdd_1 = __webpack_require__(9868);
...
var middlewareUserAgent = __webpack_require__(3982);
...
var httpAuthSchemeProvider = __webpack_require__(2625);
var runtimeConfig = __webpack_require__(9616);
var regionConfigResolver = __webpack_require__(3140);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(3742);
var errors = __webpack_require__(5570);
var SSOServiceException = __webpack_require__(234);
...
const SSOServiceException_1 = __webpack_require__(234);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3251));
const client_1 = __webpack_require__(1619);
const httpAuthSchemes_1 = __webpack_require__(9601);
const util_user_agent_node_1 = __webpack_require__(5691);
...
const runtimeConfig_shared_1 = __webpack_require__(6161);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(9601);
const protocols_1 = __webpack_require__(6773);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2625);
const endpointResolver_1 = __webpack_require__(743);
const schemas_0_1 = __webpack_require__(3742);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(5570);
const SSOServiceException_1 = __webpack_require__(234);
...
var client = __webpack_require__(1619);
var httpAuthSchemes = __webpack_require__(9601);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 784).then(__webpack_require__.t.bind(__webpack_require__, 4784, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 784).then(__webpack_require__.t.bind(__webpack_require__, 4784, 23));
