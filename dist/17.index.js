...
var client = __webpack_require__(5891);
...
var client = __webpack_require__(5891);
var tokenProviders = __webpack_require__(9880);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4284); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(4274);
...
const core_1 = __webpack_require__(7251);
...
const ruleset_1 = __webpack_require__(4120);
...
var middlewareUserAgent = __webpack_require__(1146);
...
var httpAuthSchemeProvider = __webpack_require__(5789);
var runtimeConfig = __webpack_require__(6788);
var regionConfigResolver = __webpack_require__(4579);
var protocolHttp = __webpack_require__(2810);
var schemas_0 = __webpack_require__(2794);
var errors = __webpack_require__(7678);
var SSOServiceException = __webpack_require__(8246);
...
const SSOServiceException_1 = __webpack_require__(8246);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1935));
const core_1 = __webpack_require__(7251);
const util_user_agent_node_1 = __webpack_require__(9540);
...
const runtimeConfig_shared_1 = __webpack_require__(9829);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(7251);
const protocols_1 = __webpack_require__(4293);
...
const httpAuthSchemeProvider_1 = __webpack_require__(5789);
const endpointResolver_1 = __webpack_require__(8803);
const schemas_0_1 = __webpack_require__(2794);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(7678);
const SSOServiceException_1 = __webpack_require__(8246);
...
var client = __webpack_require__(5891);
var httpAuthSchemes = __webpack_require__(1886);
var propertyProvider = __webpack_require__(8385);
var sharedIniFileLoader = __webpack_require__(4209);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 636).then(__webpack_require__.t.bind(__webpack_require__, 5636, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 636).then(__webpack_require__.t.bind(__webpack_require__, 5636, 23));
