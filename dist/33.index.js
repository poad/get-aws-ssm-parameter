...
const core_1 = __webpack_require__(3177);
const util_middleware_1 = __webpack_require__(6654);
...
const util_endpoints_2 = __webpack_require__(2147);
const ruleset_1 = __webpack_require__(5681);
...
var middlewareUserAgent = __webpack_require__(685);
var configResolver = __webpack_require__(8869);
var core = __webpack_require__(7285);
var middlewareContentLength = __webpack_require__(58);
var middlewareEndpoint = __webpack_require__(1774);
var middlewareRetry = __webpack_require__(6545);
var smithyClient = __webpack_require__(1677);
var httpAuthSchemeProvider = __webpack_require__(9906);
var runtimeConfig = __webpack_require__(5232);
var regionConfigResolver = __webpack_require__(7832);
var protocolHttp = __webpack_require__(1254);
var middlewareSerde = __webpack_require__(2864);
var core$1 = __webpack_require__(3177);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(8160));
const core_1 = __webpack_require__(3177);
const util_user_agent_node_1 = __webpack_require__(9805);
const config_resolver_1 = __webpack_require__(8869);
const hash_node_1 = __webpack_require__(9430);
const middleware_retry_1 = __webpack_require__(6545);
const node_config_provider_1 = __webpack_require__(4018);
const node_http_handler_1 = __webpack_require__(4577);
const util_body_length_node_1 = __webpack_require__(7062);
const util_retry_1 = __webpack_require__(7436);
const runtimeConfig_shared_1 = __webpack_require__(2592);
const smithy_client_1 = __webpack_require__(1677);
const util_defaults_mode_node_1 = __webpack_require__(1441);
const smithy_client_2 = __webpack_require__(1677);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(3177);
const core_2 = __webpack_require__(7285);
const smithy_client_1 = __webpack_require__(1677);
const url_parser_1 = __webpack_require__(9812);
const util_base64_1 = __webpack_require__(1532);
const util_utf8_1 = __webpack_require__(5579);
const httpAuthSchemeProvider_1 = __webpack_require__(9906);
const endpointResolver_1 = __webpack_require__(284);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(1254);
var core = __webpack_require__(7285);
var propertyProvider = __webpack_require__(4934);
var client = __webpack_require__(3201);
var signatureV4 = __webpack_require__(1232);
...
var propertyProvider = __webpack_require__(4934);
var sharedIniFileLoader = __webpack_require__(7141);
var client = __webpack_require__(3201);
var tokenProviders = __webpack_require__(6977);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1184); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(4377);
...
var client = __webpack_require__(3201);
var httpAuthSchemes = __webpack_require__(4324);
var propertyProvider = __webpack_require__(4934);
var sharedIniFileLoader = __webpack_require__(7141);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 951).then(__webpack_require__.t.bind(__webpack_require__, 3332, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 951).then(__webpack_require__.t.bind(__webpack_require__, 3332, 19));
