...
const ruleset_1 = __webpack_require__(6974);
...
var middlewareHostHeader = __webpack_require__(8296);
var middlewareLogger = __webpack_require__(8362);
var middlewareRecursionDetection = __webpack_require__(8404);
var middlewareUserAgent = __webpack_require__(7042);
...
var httpAuthSchemeProvider = __webpack_require__(5651);
var runtimeConfig = __webpack_require__(3066);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9419));
const core_1 = __webpack_require__(1336);
...
const runtimeConfig_shared_1 = __webpack_require__(323);
...
const httpAuthSchemeProvider_1 = __webpack_require__(5651);
const endpointResolver_1 = __webpack_require__(7805);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(3864);
var tokenProviders = __webpack_require__(9602);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6985); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(5323);
...
var client = __webpack_require__(3864);
var httpAuthSchemes = __webpack_require__(8459);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 666).then(__webpack_require__.t.bind(__webpack_require__, 3666, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 666).then(__webpack_require__.t.bind(__webpack_require__, 3666, 19));
