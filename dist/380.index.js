...
var tokenProviders = __webpack_require__(8353);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(247); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(6274);
...
const httpAuthSchemes_1 = __webpack_require__(7954);
...
const bdd_1 = __webpack_require__(1208);
...
var middlewareUserAgent = __webpack_require__(6882);
...
var httpAuthSchemeProvider = __webpack_require__(250);
var runtimeConfig = __webpack_require__(7508);
var regionConfigResolver = __webpack_require__(3140);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(2634);
var errors = __webpack_require__(2206);
var SSOServiceException = __webpack_require__(1590);
...
const SSOServiceException_1 = __webpack_require__(1590);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(895));
const client_1 = __webpack_require__(839);
const httpAuthSchemes_1 = __webpack_require__(7954);
const util_user_agent_node_1 = __webpack_require__(777);
...
const runtimeConfig_shared_1 = __webpack_require__(7093);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(7954);
const protocols_1 = __webpack_require__(2857);
...
const httpAuthSchemeProvider_1 = __webpack_require__(250);
const endpointResolver_1 = __webpack_require__(6611);
const schemas_0_1 = __webpack_require__(2634);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(2206);
const SSOServiceException_1 = __webpack_require__(1590);
...
var client = __webpack_require__(839);
var httpAuthSchemes = __webpack_require__(7954);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 964).then(__webpack_require__.t.bind(__webpack_require__, 8964, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 964).then(__webpack_require__.t.bind(__webpack_require__, 8964, 23));
