...
var client = __webpack_require__(4424);
...
var client = __webpack_require__(4424);
var tokenProviders = __webpack_require__(4910);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9006); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(4004);
...
const core_1 = __webpack_require__(2728);
...
const util_endpoints_1 = __webpack_require__(288);
const util_endpoints_2 = __webpack_require__(7118);
const ruleset_1 = __webpack_require__(7018);
...
var middlewareHostHeader = __webpack_require__(3475);
var middlewareLogger = __webpack_require__(91);
var middlewareRecursionDetection = __webpack_require__(1795);
var middlewareUserAgent = __webpack_require__(7487);
...
var httpAuthSchemeProvider = __webpack_require__(2311);
var runtimeConfig = __webpack_require__(4198);
var regionConfigResolver = __webpack_require__(1977);
var protocolHttp = __webpack_require__(9354);
var schemas_0 = __webpack_require__(1024);
var errors = __webpack_require__(9428);
var SSOServiceException = __webpack_require__(3031);
...
const SSOServiceException_1 = __webpack_require__(3031);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(453));
const core_1 = __webpack_require__(2728);
const util_user_agent_node_1 = __webpack_require__(2508);
...
const runtimeConfig_shared_1 = __webpack_require__(7999);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(2728);
const protocols_1 = __webpack_require__(2208);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2311);
const endpointResolver_1 = __webpack_require__(4753);
const schemas_0_1 = __webpack_require__(1024);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(9428);
const SSOServiceException_1 = __webpack_require__(3031);
...
var client = __webpack_require__(4424);
var httpAuthSchemes = __webpack_require__(2539);
var propertyProvider = __webpack_require__(2366);
var sharedIniFileLoader = __webpack_require__(542);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 930).then(__webpack_require__.t.bind(__webpack_require__, 7930, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 930).then(__webpack_require__.t.bind(__webpack_require__, 7930, 23));
