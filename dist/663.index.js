...
const ruleset_1 = __webpack_require__(4560);
...
var middlewareHostHeader = __webpack_require__(2575);
var middlewareLogger = __webpack_require__(4631);
var middlewareRecursionDetection = __webpack_require__(8583);
var middlewareUserAgent = __webpack_require__(1516);
var configResolver = __webpack_require__(705);
var core = __webpack_require__(9186);
...
var middlewareRetry = __webpack_require__(2404);
var smithyClient = __webpack_require__(2641);
var httpAuthSchemeProvider = __webpack_require__(1285);
var runtimeConfig = __webpack_require__(4700);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(4625));
const core_1 = __webpack_require__(8220);
...
const runtimeConfig_shared_1 = __webpack_require__(8525);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1285);
const endpointResolver_1 = __webpack_require__(2603);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(9828);
var tokenProviders = __webpack_require__(244);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(7518); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(5882);
...
var client = __webpack_require__(9828);
var httpAuthSchemes = __webpack_require__(8007);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 992).then(__webpack_require__.t.bind(__webpack_require__, 2992, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 992).then(__webpack_require__.t.bind(__webpack_require__, 2992, 19));
