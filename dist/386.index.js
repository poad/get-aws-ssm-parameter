...
const core_1 = __webpack_require__(7100);
...
const util_endpoints_1 = __webpack_require__(1752);
const util_endpoints_2 = __webpack_require__(2313);
const ruleset_1 = __webpack_require__(7490);
...
var middlewareUserAgent = __webpack_require__(6898);
...
var httpAuthSchemeProvider = __webpack_require__(1055);
var runtimeConfig = __webpack_require__(238);
...
var core$1 = __webpack_require__(7100);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9423));
const core_1 = __webpack_require__(7100);
const util_user_agent_node_1 = __webpack_require__(32);
...
const runtimeConfig_shared_1 = __webpack_require__(4647);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1055);
const endpointResolver_1 = __webpack_require__(4681);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(6804);
...
var client = __webpack_require__(6804);
var tokenProviders = __webpack_require__(3794);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(2557); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(3756);
...
var client = __webpack_require__(6804);
var httpAuthSchemes = __webpack_require__(999);
var propertyProvider = __webpack_require__(4124);
var sharedIniFileLoader = __webpack_require__(6547);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 834).then(__webpack_require__.t.bind(__webpack_require__, 6834, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 834).then(__webpack_require__.t.bind(__webpack_require__, 6834, 19));
