...
var tokenProviders = __webpack_require__(8570);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9165); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(9326);
...
var client$1 = __webpack_require__(6015);
...
var httpAuthSchemes = __webpack_require__(8282);
var serde = __webpack_require__(6129);
var nodeHttpHandler = __webpack_require__(7135);
var protocols$1 = __webpack_require__(2177);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 120).then(__webpack_require__.t.bind(__webpack_require__, 5120, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 120).then(__webpack_require__.t.bind(__webpack_require__, 5120, 19));
