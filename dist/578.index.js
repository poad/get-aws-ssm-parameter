...
const ruleset_1 = __webpack_require__(7827);
...
var httpAuthSchemeProvider = __webpack_require__(7396);
var runtimeConfig = __webpack_require__(1085);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(5174));
const core_1 = __webpack_require__(6113);
...
const runtimeConfig_shared_1 = __webpack_require__(1986);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7396);
const endpointResolver_1 = __webpack_require__(6394);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(2217);
var tokenProviders = __webpack_require__(2755);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1021); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(6971);
...
var client = __webpack_require__(2217);
var httpAuthSchemes = __webpack_require__(9708);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(1247);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 693).then(__webpack_require__.t.bind(__webpack_require__, 1693, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 693).then(__webpack_require__.t.bind(__webpack_require__, 1693, 19));
