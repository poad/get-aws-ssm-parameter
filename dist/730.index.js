...
var tokenProviders = __webpack_require__(3678);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(5681); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(2959);
...
var middlewareHostHeader = __webpack_require__(6790);
var middlewareLogger = __webpack_require__(1721);
var middlewareRecursionDetection = __webpack_require__(1063);
var middlewareUserAgent = __webpack_require__(4416);
var core = __webpack_require__(1324);
var client = __webpack_require__(7668);
var config = __webpack_require__(2633);
var endpoints = __webpack_require__(7067);
var protocols = __webpack_require__(3996);
var retry = __webpack_require__(8863);
var schema = __webpack_require__(1892);
var httpAuthSchemes = __webpack_require__(7270);
var client$1 = __webpack_require__(4987);
var utilUserAgentNode = __webpack_require__(1813);
var serde = __webpack_require__(2388);
var nodeHttpHandler = __webpack_require__(5774);
var protocols$1 = __webpack_require__(5069);
var utilEndpoints = __webpack_require__(4481);
var regionConfigResolver = __webpack_require__(8749);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 575).then(__webpack_require__.t.bind(__webpack_require__, 8575, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 575).then(__webpack_require__.t.bind(__webpack_require__, 8575, 19));
