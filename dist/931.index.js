...
const shared_ini_file_loader_1 = __webpack_require__(981);
const fs_1 = __webpack_require__(9896);
const fromWebToken_1 = __webpack_require__(7000);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(2241)));
...
var fromTokenFile = __webpack_require__(2024);
var fromWebToken = __webpack_require__(7000);
